...
silos_ids = ["df_0_4", "df_4_8", "df_8_12", "df_12_15"]
...
def client_fn(context: Context):
    ...
    silo = silos_ids[partition_id]
    path = os.path.join("silos", f"{silo}.parquet")
    df_silo = pd.read_parquet(path)

    train_loader, val_loader, training_ds = load_datasets(df_silo)
